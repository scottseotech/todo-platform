...
helm template loki grafana/loki --namespace $NAMESPACE -f ./custom-values.yaml > all-resources.yaml
...
#
# In Add Datasource
# Set up the connection URL as http://loki.logging.svc.cluster.local:3100
